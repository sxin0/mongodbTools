...
/** Connection **/
$message["can_not_connect"] = "MongoDB连接异常:% s。请检查你的配置.";
$message["can_not_auth"] = "MongoDB验证失败。请从您的mongo管理员检查您的用户名和密码.";
...
$message["create_collection"] = "New Collection";
$message["create_collection_full"] = "Create new Collection";
$message["create_database"] = "Create new Database";
$message["save"] = "Save";
$message["back"] = "Back";
...
<p>如果你有任何问题，请给我发电子邮件: <a href="mailto:iwind.liu@gmail.com">iwind.liu@gmail.com</a> .</p>
