...
$MONGO = array();
$MONGO["features"]["log_query"] = "on";//日志查询
$MONGO["features"]["theme"] = "default";//主题
$MONGO["features"]["plugins"] = "on";//插件
...
$MONGO["servers"][$i]["control_users"][""] = "";//one of control users ["USERNAME"]=PASSWORD, works only if mongo_auth=false
